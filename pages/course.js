...
import { Nav, Whole, Left, A, Right, Body } from "../components/pages/course"
import { All, Lecture, Lab, Li, H2, Span } from "../components/SlideList"
...
const Course_Inpage = () => {
  ...
  return (
    <Layout>
      <CustomHeader />
      <Nav>
        <p onClick={() => setCourse(false)}>slides</p>
        <p onClick={() => setCourse(true)}>Home</p>
      </Nav>
      {course ? Home : Slide_list}
    </Layout>
  )
}
